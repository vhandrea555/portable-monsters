...
class BuildingHealthCenter3 extends Building{

public static inline var MAX_TILE_SIZE:Int = 32;
public function new(){
super();
ExitLocation.x = 61;ExitLocation.y = 74;
MapDoorLocation.x = 61;MapDoorLocation.y = 73;
...
override public function initializeCharacters()
{
 ...
 var Nurse = new Character
  ...
  if(currentTalkingCharacter.ID == 5)
  {
	...
	{
	  Text.htmlText = "<font size='16'>Nurse: I never really wanted be a nurse.  It just seem like a good idea at the time.</font>";
	}
