...
class BuildingCastle4 extends Building{

public static inline var MAX_TILE_SIZE:Int = 32;
public function new(){
super();
ExitLocation.x = 59;ExitLocation.y = 15;
ExitLocation1.x = 59;ExitLocation1.y=15;
MapDoorLocation.x = 59;MapDoorLocation.y = 14;
MapDoorLocation2.x = 57;MapDoorLocation2.y=12;
ExitLocation2.x = 58;ExitLocation2.y = 12;
...
override public function getTrainerNextLine()
{
  ...
  if(currentTrainer.ID == 1)
  {
	...
	if(currentTalkingStep == 0)
	{
	  Text.htmlText = "<font size='16'>Have you decided what you wanted to do?</font>";
	}
	else
	{
	  WorldMap.removeChild(TextBox);
    ...
    else
    {
      	if(currentTalkingStep == 0)
	{
	  Text.htmlText = "<font size='16'>Top 4 Leader: We have an opening, did you want to join?</font>";
	}
      	else if(currentTalkingStep == 1)
	{
	  Text.htmlText = "<font size='16'>Eve: No, I'm not really cut out for this stuff.</font>";
	}
	else
	{
	  currentPlot.State = "Beat Game";
	  WorldMap.removeChild(TextBox);
