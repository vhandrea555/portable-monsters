...
class BuildingHealthCenter5 extends Building{

public static inline var MAX_TILE_SIZE:Int = 32;
public function new(){
super();
ExitLocation.x = 63;ExitLocation.y = 29;
MapDoorLocation.x = 63;MapDoorLocation.y = 28;
...
override public function initializeCharacters()
{
 ...
 var Nurse = new Character
  ...
  if(currentTalkingCharacter.ID == 5)
  {
	...
	{
	  Text.htmlText = "<font size='16'>Nurse: How come you're so much more successful than me.</font>";
	}
