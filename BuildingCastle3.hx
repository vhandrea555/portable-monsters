...
class BuildingCastle3 extends Building{

public static inline var MAX_TILE_SIZE:Int = 32;
public function new(){
super();
ExitLocation.x = 59;ExitLocation.y = 18;
ExitLocation1.x = 59;ExitLocation1.y=18;
MapDoorLocation.x = 59;MapDoorLocation.y = 17;
MapDoorLocation2.x = 57;MapDoorLocation2.y=15;
ExitLocation2.x = 58;ExitLocation2.y = 15;
...
override public function getTrainerNextLine()
{
  ...
  if(currentTrainer.ID == 1)
  {
	...
	if(currentTalkingStep == 0)
	{
	  Text.htmlText = "<font size='16'>I was given all my Monsters as a gift.</font>";
	}
	else
	{
	  WorldMap.removeChild(TextBox);
    ...
    else
    {
      	if(currentTalkingStep == 0)
	{
	  Text.htmlText = "<font size='16'>I like cats, because they're faster than the other monsters.</font>";
	}
	else
	{
	  WorldMap.removeChild(TextBox);
