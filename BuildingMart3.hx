...
class BuildingMart3 extends Building{
...
ExitLocation.x = 74;ExitLocation.y = 62;
MapDoorLocation.x = 74;MapDoorLocation.y = 61;
...
override public function getNextLine()
{
  ...
  if(currentTalkingCharacter.ID == 1)
  {
    if(currentTalkingCharacter.TalkedTo >= 0)
    {
      ...
      {
	Text.htmlText = "<font size='16'>It Cost 1200 to enter this Gym</font>";
      }
