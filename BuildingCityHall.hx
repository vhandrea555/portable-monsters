...
class BuildingCityHall extends Building{

public static inline var MAX_TILE_SIZE:Int = 32;
public function new(){
super();
ExitLocation.x = 6;ExitLocation.y = 9;
MapDoorLocation.x = 6;MapDoorLocation.y = 8;
...
override public function initializeCharacters()
{
 ...
 var Mayor = new Character
  ...
  Mayor.ID = 4;
  _characterMap[Mayor.centerY][Mayor.centerX] = Mayor.ID;
