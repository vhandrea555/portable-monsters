...
class BuildingHealthCenter4 extends Building{

public static inline var MAX_TILE_SIZE:Int = 32;
public function new(){
super();
ExitLocation.x = 54;ExitLocation.y = 49;
MapDoorLocation.x = 54;MapDoorLocation.y = 48;
...
override public function initializeCharacters()
{
 ...
 var Nurse = new Character
  ...
  if(currentTalkingCharacter.ID == 5)
  {
	...
	{
	  Text.htmlText = "<font size='16'>Nurse: You know, I was once a Trainer...</font>";
	}
