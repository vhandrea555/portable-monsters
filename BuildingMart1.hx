...
class BuildingMart1 extends Building{
...
ExitLocation.x = 5;ExitLocation.y = 30;
MapDoorLocation.x = 5;MapDoorLocation.y = 29;
...
override public function getNextLine()
{
  ...
  if(currentTalkingCharacter.ID == 1)
  {
    if(currentTalkingCharacter.TalkedTo >= 0)
    {
      ...
      {
	Text.htmlText = "<font size='16'>Some Guy: It Cost 500 to enter this Gym</font>";
      }
